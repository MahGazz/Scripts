...
do -- Example UI
    local Window = library:AddWindow("Last Piece", {
        main_color = Color3.fromRGB(41, 74, 122),
    ...
    local Tab2 = Window:AddTab("Credits")
    ...
    do -- Elements
				...
				if v:IsA("Model") and v:FindFirstChildWhichIsA("Tool") then
					for _, player in pairs(game.Players:GetPlayers()) do
						if v.Name ~= player.Name then
							if not v:FindFirstChildWhichIsA("Tool").Handle:FindFirstChild("BillboardGui") then
        ...
        Tab:AddButton("Timer", function()
            game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Timer", Text = workspace.Time.Hour.Value..":"..workspace.Time.Minute.Value..":"..workspace.Time.Second.Value})
        end)
    end
    
    do
        Tab2:AddLabel("Scripting: RouTheCoder on Ph4n")
        Tab2:AddLabel("UI Credits: 0xSingularity on V3rm")
    end 
