			...
			function window_data:AddTab(tab_name)
				...
				do -- Tab Elements
					...
					function tab_data:AddLabel(label_text) -- [Label]
						...
						function label_data:Set(new_title)
							label.Text = tostring(new_title or "New Label")
						end
						
						function label_data:Remove()
							label:Destroy()
						end
					...
					function tab_data:AddButton(button_text, callback) -- [Button]
						...
						function button_data:Set(new_title)
							button.Text = tostring(new_title or "New Button")
						end
						
						function button_data:Del()
							button:Destroy()
						end
...
do -- Example UI
	...
	local Tab2 = Window:AddTab("ESP STATS")
	local Tab3 = Window:AddTab("Credits")
	...
	do -- Elements
		...
		Tab:AddTextBox("Player Name", function(text)
			for _,v in pairs(workspace.Characters:GetChildren()) do
				if v.Name == text then
					if not v.HumanoidRootPart:FindFirstChild("BillboardGui") then
						local BillboardGui = Instance.new("BillboardGui", v.HumanoidRootPart)
						...
						TextLabel.Font = "LuckiestGuy"
						TextLabel.Text = v.Name
						TextLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
						TextLabel.TextScaled = true
						TextLabel.TextStrokeColor3 = Color3.fromRGB(230, 230, 230)
	...
	do
		local lvlESP = Tab2:AddLabel("Level: ")
		local raceESP = Tab2:AddLabel("Race: ")
		local dfESP = Tab2:AddLabel("Devil Fruit: ")
		local beliESP = Tab2:AddLabel("Beli: ")
		Tab2:AddLabel("==========")
		local meleestts = Tab2:AddLabel("Melee: ")
		local defstts = Tab2:AddLabel("Defense: ")
		local swordstts = Tab2:AddLabel("Sword: ")
		local gunstts = Tab2:AddLabel("Gun: ")
		local dfstts = Tab2:AddLabel("Blox Fruit: ")
		
		Tab2:AddTextBox("Player Name", function(text)
			local name = text
			lvlESP:Set("Level: "..game.Players[name].Data.Level.Value)
			raceESP:Set("Race: "..game.Players[name].Data.Race.Value)
			dfESP:Set("Devil Fruit: "..game.Players[name].Data.DevilFruit.Value)
			beliESP:Set("Beli: "..game.Players[name].Data.Beli.Value)
			meleestts:Set("Melee: "..game.Players[name].Data.Stats.Melee.Level.Value)
			defstts:Set("Defense: "..game.Players[name].Data.Stats.Defense.Level.Value)
			swordstts:Set("Sword: "..game.Players[name].Data.Stats.Sword.Level.Value)
			gunstts:Set("Gun: "..game.Players[name].Data.Stats.Gun.Level.Value)
			dfstts:Set("Blox Fruit: "..game.Players[name].Data.Stats['Demon Fruit'].Level.Value)
		end, {
			["clear"] = false, -- Default: true (options are optional)
		})
	...
	do
		Tab3:AddLabel("Scripting: RouTheCoder on Ph4n")
		Tab3:AddLabel("UI Credits: 0xSingularity on V3rm")
	end	
